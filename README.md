...
### 2026-04
- 学生アカウントの編集・削除機能を追加（PR #27）
- メッセージログの30日自動削除を実装（PR #26）
- README を刷新（PR #28）

### 2025-10
- AIからの定期メッセージ通知機能（15時に自動送信）を追加（PR #25）
- ニュース・記事推薦機能を追加（NHK RSS / Bing Web Search / Mastodon）（PR #23, #24）
- 会話の自動要約・メモ機能を追加（PR #22）
- 使用モデルを gpt-5-nano に変更（PR #19）
- メッセージ履歴・閲覧ログ機能を追加（PR #15）
- 教員ダッシュボードのバグ修正（PR #12）
- AIからのメッセージ受信機能を追加（PR #10, #11）
- 管理者機能を拡充（教師ステータス変更・一括管理）（PR #7, #9）
- 教員との1対1チャット機能を追加（PR #6）
- Google OAuth ログイン機能を追加（PR #3）
- Ollama（ローカル LLM）対応を追加
- チャット・リスク分析機能の初期実装（PR #1）
